// Human-readable hints shown for issues that cannot be auto-fixed safely.
...
// Matches a standalone, single-line console.log statement: `console.log(...)` or `console.log(...);`
...
// Removes only lines the scanner flagged (1-based issueLines) that are safe,
// standalone console.log statements. Inline uses and multi-line calls are skipped.
